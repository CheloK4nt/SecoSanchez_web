    ...
    <div class="panel shadow">
        <div class="header">
            <div style="padding-inline-end: 10px;" class="row">
                <div class="col-11">
                    <h2 class="title"><i class="fas fa-plus-square logo-addprod"></i>Agregar Spray</h2>
                </div>
                <div class="col-1">
                    <input class="form-control form-id-prod text-center" type="text" id="id_prod" name="id_prod" placeholder="{{$id_spray}}" value="{{$id_spray}}" readonly>
                </div>
            </div>
        ...
        <div class="inside">
            <form class="col-12 needs-validation" action="{{ url('admin/producto/spray/store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
                <div class="row">
                    <div class="col-md-5">
                ...
                <input class="form-control form-id-prod" type="text" id="id_prod" name="id_prod" placeholder="{{$id_spray}}" value="{{$id_spray}}" readonly hidden>
