    ...
    <div class="row">
            ...
            <div class="panel shadow">
                <div class="header">
                    <div style="padding-inline-end: 10px; margin-right: 20px;" class="row">
                        <div class="col-11">
                            <h2 class="title"><i class="fas fa-plus-square logo-addprod"></i>Editar Cuadro</h2>
                        </div>
                        <div class="col-1">
                            <input class="form-control form-id-prod text-center" type="text" id="id_prod" name="id_prod" placeholder="{{$cuadro->id_cuadro}}" value="{{$cuadro->id_cuadro}}" readonly>
                        </div>
                    </div>
                ...
                <div class="inside">
                    <form class="col-12 needs-validation" action="{{ route('cuadro.update', $cuadro->id_cuadro) }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'{{-- maxlength="3" type="number" --}} id="alto_cdr" name="alto_cdr" min="0"
                                        placeholder="Altura del producto" value="{{ $cuadro->alto }}" required >
                                    <div class="valid-feedback"></div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="ancho_cdr" name="ancho_cdr" min="0"
                                        placeholder="Ancho del producto" value="{{ $cuadro->ancho }}" required>
                                    <div class="valid-feedback"></div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="largo_cdr" name="largo_cdr" min="0"
                                        placeholder="Largo del producto" value="{{ $cuadro->largo }}" required>
                                    <div class="valid-feedback"></div>
                        ...
                        <input class="form-control form-id-prod" type="text" id="id_prod" name="id_prod" placeholder="{{$cuadro->id_cuadro}}" value="{{$cuadro->id_cuadro}}" readonly hidden>
        ...
        <div class="col-md-3">
            <div class="panel shadow">
                ...
                <div class="inside">
                    <img src="{{url('/uploads/productos/cuadros/'.$prod->file_path.'/t_'.$prod->img_prod)}}" class="img-fluid" data-fancybox="gallery">
                </div>
            </div>
            ...
            <div class="panel shadow mt-2">
                ...
                <div class="inside product_gallery">
                    <form class="col-12 needs-validation" action="{{ route('cuadro.galeria.agregar', $prod->id_prod) }}" method="POST" enctype="multipart/form-data" id="form_galeria" novalidate>
                    @csrf
                        <div class="input-group">
                    ...
                    <div class="tumbs">
                        ...
                        <div class="tumb">
                            <a class="btn btn-info" href="{{ url('/admin/producto/cuadro/'.$prod->id_prod.'/galeria/'.$img->id_gal.'/eliminar') }}"><i class="fas fa-trash"></i></a>
                            <img src="{{ url('/uploads/productos/cuadros/'.$img->file_path.'/t_'.$img->file_name) }}" alt="" data-fancybox="gallery">
                        </div>
                        @endforeach
                    </div>
                </div>
